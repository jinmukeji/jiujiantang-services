...
import (
	...
	jwtmiddleware "github.com/jinmukeji/jiujiantang-services/pkg/rest.v3/jwt"
)
...
func TestBasicJwt(t *testing.T) {
	...
	e.GET("/secured/ping").WithHeader("Authorization", tokenString).
