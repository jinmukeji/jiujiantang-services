...
func jinmuHealthOptions() micro.Option {
	return micro.Flags(
		&cli.StringFlag{
			...
			EnvVars:     []string{"X_AE_CONFIG_DIR"},
...
func algorithmClientOptions() micro.Option {
	return micro.Flags(
		&cli.StringFlag{
			...
			EnvVars:     []string{"X_ALGORITHM_SERVER_ADDRESS"},
...
func wechatOptions() micro.Option {
	return micro.Flags(
		...
		&cli.StringFlag{
			...
			Value:       "",
			Usage:       "微信公众平台 开发者密码",
			EnvVars:     []string{"X_WX_APP_SECRET"},
		...
		&cli.StringFlag{
			...
			EnvVars:     []string{"X_WX_ENCODED_AES_KEY"},
		...
		&cli.StringFlag{
			...
			Value:       "",
			Usage:       "微信公众平台 模版ID",
			EnvVars:     []string{"X_WX_Template_ID"},
		...
		&cli.StringFlag{
			...
			Value:       "",
			Usage:       "喜马把脉 H5地址",
			EnvVars:     []string{"X_JINMU_H5_SERVER_BASE"},
		...
		&cli.StringFlag{
			...
			Value:       "",
			Usage:       "喜马把脉 v2 H5地址",
			EnvVars:     []string{"X_JINMU_H5_SERVER_BASE_V2_0"},
		...
		&cli.StringFlag{
			...
			Value:       "",
			Usage:       "喜马把脉 v2 H5地址",
			EnvVars:     []string{"X_JINMU_H5_SERVER_BASE_V2_1"},
