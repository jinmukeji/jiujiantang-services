module github.com/jinmukeji/gf-api2
...
require (
	...
	github.com/chanxuehong/util v0.0.0-20200101141541-cec33d5d7fcd // indirect
	...
	github.com/jinmukeji/ae/v2 v2.10.1
	github.com/jinmukeji/go-pkg v1.1.0
